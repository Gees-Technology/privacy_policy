# Privacy Policy for Muqdishaawi Exchange

**Effective Date:** February 12, 2026

This Privacy Policy describes how Muqdishaawi Exchange (referred to as "Muqdishaawi Exchange", "we", "us", or "our") collects, uses, and shares information when you download, install, or use our mobile application (the "App"). By using the App you agree to the collection and use of information described in this policy.

**App and Service Overview**

- App name: Muqdishaawi Exchange (displayed in the app as "Muqdishaawi Exchange").
...
- Firebase project ID: `muqdishaawi-exchange` (see repository `firebase.json` / generated `firebase_options.dart`).
- Android package name: `com.geestechnology.muqdishaawi`.
- iOS bundle identifier: `com.geestechnology.muqdishaawi`.

These identifiers are used for app store and Firebase configuration and are available in the project configuration files.
...
- **Email:** <support@geestechnology.com>  
- **Project / Firebase project ID:** muqdishaawi-exchange  
- **Package / Bundle:** `com.geestechnology.muqdishaawi`
